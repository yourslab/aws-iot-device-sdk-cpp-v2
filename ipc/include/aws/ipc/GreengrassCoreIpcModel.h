        ...
        namespace GreengrassCoreIpc
        {
            ...
            class ValidateConfigurationUpdateEvent : public AbstractShapeBase
            {
              public:
                ...
                void SetConfiguration(const Crt::JsonObject &configuration) noexcept
                {
            ...
            class SendConfigurationValidityReportRequest : public OperationRequest
            {
              public:
                ...
                void SetConfigurationValidityReport(
                    const ConfigurationValidityReport &configurationValidityReport) noexcept
                {
            ...
            class ListComponentsResponse : public OperationResponse
            {
              public:
                ...
                void SetComponents(const Crt::Vector<ComponentDetails> &components) noexcept
                {
            ...
            class DeferComponentUpdateRequest : public OperationRequest
            {
              public:
                ...
                void SetMessage(const Crt::String &message) noexcept { m_message = message; }
                Crt::Optional<Crt::String> GetMessage() noexcept { return m_message; }
                void SetRecheckAfterMs(const int &recheckAfterMs) noexcept { m_recheckAfterMs = recheckAfterMs; }
            ...
            class CreateLocalDeploymentRequest : public OperationRequest
            {
              public:
                ...
                void SetComponentToRunWithInfo(
                    const Crt::Map<Crt::String, RunWithInfo> &componentToRunWithInfo) noexcept
                {
