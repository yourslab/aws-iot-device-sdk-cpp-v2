    ...
    namespace Eventstreamrpc
    {
        namespace EchoTestRpc
        {
            void Product::SerializeToJsonObject(Crt::JsonObject &payloadObject) const noexcept
            {
                ...
                {
                    payloadObject.WithDouble("price", m_price.value());
                }
            }
            ...
            void Product::s_loadFromJsonView(Product &product, const Crt::JsonView &jsonView) noexcept
            {
                ...
                {
                    product.m_price = Crt::Optional<double>(jsonView.GetDouble("price"));
                }
            }
            ...
            void Customer::SerializeToJsonObject(Crt::JsonObject &payloadObject) const noexcept
            {
                if (m_id.has_value())
                {
                    payloadObject.WithInteger("id", m_id.value());
                }
            ...
            void Customer::s_loadFromJsonView(Customer &customer, const Crt::JsonView &jsonView) noexcept
            {
                ...
                {
                    customer.m_id = Crt::Optional<int>(jsonView.GetInteger("id"));
                }
            ...
            void MessageData::s_loadFromJsonView(MessageData &messageData, const Crt::JsonView &jsonView) noexcept
            {
                ...
                if (jsonView.ValueExists("timeMessage"))
                {
                    messageData.m_timeMessage =
                        Crt::Optional<Crt::DateTime>(Crt::DateTime(jsonView.GetDouble("timeMessage")));
                }
                ...
                const Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("message"))
                {
                    ...
                    MessageData::s_loadFromJsonView(
                        echoMessageResponse.m_message.value(), jsonView.GetJsonObject("message"));
                }
            }
                ...
                const Crt::JsonView &jsonView) noexcept
            {
                if (jsonView.ValueExists("message"))
                {
                    ...
                    MessageData::s_loadFromJsonView(
                        echoMessageRequest.m_message.value(), jsonView.GetJsonObject("message"));
                }
            }

            Crt::String EchoMessageRequest::GetModelName() const noexcept
            {
            ...
            GetAllProductsOperationContext::GetAllProductsOperationContext(
            ...
            Crt::ScopedResource<OperationResponse> CauseServiceErrorOperationContext::
            ...
            Crt::Optional<Crt::String> CauseStreamServiceToErrorOperationContext::GetStreamingResponseModelName()
                const noexcept
            {
                return Crt::String("awstest#EchoStreamingMessage");
            }
            ...
            Crt::ScopedResource<OperationResponse> EchoStreamMessagesOperationContext::
                AllocateInitialResponseFromPayload(Crt::StringView stringView, Crt::Allocator *allocator) const noexcept
            {
                return EchoStreamingResponse::s_allocateFromPayload(stringView, allocator);
            }
            ...
            Crt::Optional<Crt::String> EchoStreamMessagesOperationContext::GetStreamingResponseModelName()
                const noexcept
            {
                return Crt::String("awstest#EchoStreamingMessage");
            }
            ...
            EchoMessageOperationContext::EchoMessageOperationContext(
                const EchoTestRpcServiceModel &serviceModel) noexcept
                : OperationModelContext(serviceModel)
            {
            }
            ...
            Crt::ScopedResource<OperationResponse> GetAllCustomersOperationContext::
                AllocateStreamingResponseFromPayload(Crt::StringView stringView, Crt::Allocator *allocator)
                    const noexcept
            {
                return nullptr;
